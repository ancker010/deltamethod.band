---
layout: post
title: Example post 2 title should be long enough, to be a small description as well, as just a regular title
category: home
image: assets/img/post-2.jpg
image_alt: Post image cover
published: false
---
This is excerpt of a post. It will appear in the page of it's category with the description or excerpt shown. Clicking each of them will redirect to the page of the post.
